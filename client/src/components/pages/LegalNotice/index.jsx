...
const LegalNotice = () => (
  ...
  <div className="legalnotice">
    ...
    <div className="legalnotice__titre"> mentions legales </div>
    ...
    <div className="legalnotice__content">
      ...
      <div className="legalnotice__content_presentation">
        <LegalNoticeContent
          ...
          text="En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il est précisé aux utilisateurs du site www.ofarm.fr l'identité des différents intervenants dans le cadre de sa réalisation et de son suivi :

Le présent site est édité par : Florian NGUYEN, Particulier ayant pour numéro de SIRET XX XX et qui est domiciliée au 10 rue des fleurs, 31 000 Toulouse

Responsable de la publication : Florian NGUYEN, joignable par téléphone au 06 XX XX XX XX et par email floriannguyen@gmail.com

Webmaster du site: freelance, joingnable par téléphone au 06 XX XX XX XX

Hébergeur du site: Netlify, qui est domicilié à San Francisco et joignable par téléphone au xx xx xx xx xx"
        />
      </div>
      ...
      <div className="legalnotice__content_propriete">
        <LegalNoticeContent
          ...
          text="L’entreprise O'Farm est propriétaire des droits de propriété intellectuelle ou détient les droits d’usage sur tous les éléments accessibles sur le site, notamment : les textes, les images, les graphismes, le logo, les icônes,…

Toute reproduction, représentation, modification, publication, adaptation de tout ou partie des éléments du site, quel que soit le moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable de l’entreprise O'Farm.
...
Toute exploitation non autorisée du site ou d’un quelconque élément qu’il contient sera considérée comme constitutive d’une contrefaçon et poursuivie conformément aux dispositions des articles L.335-2 et suivants du Code de Propriété Intellectuelle."
      ...
      <div className="legalnotice__content_cookies">
        <LegalNoticeContent
          ...
          text="Le site internet www.ofarm.fr possède un système de mesure d’audience, ainsi qu’une fonction de partage sur les réseaux sociaux.
...
Le refus d’installation d’un cookie peut entraîner l’impossibilité d’accéder à certains services. L’internaute peut toutefois configurer son navigateur internet pour refuser l’installation des cookies."
      ...
      <div className="legalnotice__content_reseaux">
        <LegalNoticeContent titre="Réseaux sociaux" text="Les cookies liés aux réseaux sociaux sont associés aux boutons qui facilitent le partage des pages et articles sur les réseaux sociaux." />
      </div>
...
En aucun cas, votre adresse e-mail ne sera cédée à des tiers."
      ...
      <div className="legalnotice__content_liens">
        <LegalNoticeContent titre="Liens hypertextes" text="Ce site internet contient un certain nombre de liens hypertextes vers d’autres sites. Cependant, www.ofarm.fr n’a pas la possibilité de suivre et vérifier le contenu de ces sites, et n’assumera en conséquence aucune responsabilité de ce fait." />
      </div>
