...
const PitchContainer = () => (
  <div className="pitch-container">
    <Grid container>
      ...
      <Grid item container justifyContent="flex-start" lg={12} mb={5}>
        <Grid item lg={9} md={9}>
          <PitchSection
      ...
      <Grid item container justifyContent="flex-end" lg={12} mb={3}>
        <Grid item lg={9} md={9}>
          <PitchSection
